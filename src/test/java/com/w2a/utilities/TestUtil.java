...
/*public static String mailscreenshotpath;
	...
	public static void captureScreenshot(String methodName) throws IOException{
	    ...
	    try {
	    	mailscreenshotpath = System.getProperty("user.dir")+"\\target\\surefire-reports\\html\\"+methodName+"_"+year+"_"+date+"_"+(month+1)+"_"+day+"_"+min+"_" +sec+".jpeg";
	...
	public static void captureScreenshot(String methodName) throws IOException {
		...
		Date d = new Date();
		screenshotName = d.toString().replace(":", "_").replace(" ", "_")+methodName+".jpg";
